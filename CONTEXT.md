...
- Exposes quality options, including audio-only formats when available, and subtitle options to the frontend
- Supports natural, converted, and both output modes, including audio-only converted output
